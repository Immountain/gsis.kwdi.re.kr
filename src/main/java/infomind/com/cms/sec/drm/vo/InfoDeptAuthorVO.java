package infomind.com.cms.sec.drm.vo;
...
public class InfoDeptAuthorVO extends InfoDeptAuthor {
	/**
	 * serialVersionUID
	 */
	 ...
	 * 부서권한목록
	 */
	List <InfoDeptAuthorVO> deptAuthorList;
	/**
	 * 부서목록
	 */
	List <InfoDeptAuthorVO> deptList;
	/**
	 * 부서코드
	 */
	 ...
	 */
	public List<InfoDeptAuthorVO> getDeptAuthorList() {
	 ...
	 */
	public void setDeptAuthorList(List<InfoDeptAuthorVO> deptAuthorList) {
	 ...
	 * @return List<DeptAuthorVO>
	 */
	public List<InfoDeptAuthorVO> getDeptList() {
		return deptList;
	}
	/**
	 ...
	 */
	public void setDeptList(List<InfoDeptAuthorVO> deptList) {
