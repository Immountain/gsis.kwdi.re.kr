...
public class InfoAuthorManageVO extends InfoAuthorManage {

	private static final long serialVersionUID = 1L;

	List <InfoAuthorManageVO> authorManageList;
	 ...
	 */
	public List<InfoAuthorManageVO> getAuthorManageList() {
	 ...
	 */
	public void setAuthorManageList(List<InfoAuthorManageVO> authorManageList) {
