...
public class InfoAuthorGroup extends CmsSearchVO {
	/**
	 * serialVersionUID
	 */
	 ...
	 * 권한그룹관리
	 */
	private InfoAuthorGroup authorGroup;
	/**
	 * 설정대상 사용자 ID
	 */
	...
	public String getJtpOrganCd() {
		return jtpOrganCd;
	}

	public void setJtpOrganCd(String jtpOrganCd) {
		this.jtpOrganCd = jtpOrganCd;
	}

	public String getJtpOrganCdNm() {
		return jtpOrganCdNm;
	}

	public void setJtpOrganCdNm(String jtpOrganCdNm) {
		this.jtpOrganCdNm = jtpOrganCdNm;
	}
	 ...
	 * @return AuthorGroup
	 */
	public InfoAuthorGroup getAuthorGroup() {
		return authorGroup;
	}
	/**
	 ...
	 */
	public void setAuthorGroup(InfoAuthorGroup authorGroup) {
