...
public class InfoGroupManageVO extends InfoGroupManage {
	 ...
	 * 그룹 목록
	 */	
	List <InfoGroupManageVO> groupManageList;
	/**
	 * 삭제대상 목록
	 */		
    String[] delYn;
	 ...
	 */
	public List<InfoGroupManageVO> getGroupManageList() {
	 ...
	 */
	public void setGroupManageList(List<InfoGroupManageVO> groupManageList) {
