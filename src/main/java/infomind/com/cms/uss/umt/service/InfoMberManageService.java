 ...
 * </pre>
 */
public interface InfoMberManageService {
	 ...
	 * @throws Exception
	 */
	public InfoMberManageVO selectMber(String mberId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<InfoMberManageVO> selectMberList(CmsSearchVO userSearchVO) throws Exception;
     ...
     * @throws Exception
     */
    public int selectMberListTotCnt(CmsSearchVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updatePassword(InfoMberManageVO mberManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public InfoMberManageVO selectPassword(InfoMberManageVO passVO) throws Exception;
