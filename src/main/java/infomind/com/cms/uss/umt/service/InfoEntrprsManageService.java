 ...
 * </pre>
 */
public interface InfoEntrprsManageService {
	 ...
	 * @throws Exception
	 */
	public InfoEntrprsManageVO selectEntrprsmber(String entrprsmberId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updatePassword(InfoEntrprsManageVO entrprsManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public InfoEntrprsManageVO selectPassword(InfoEntrprsManageVO passVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<InfoEntrprsManageVO> selectEntrprsMberList(CmsSearchVO userSearchVO) throws Exception;
     ...
     * @throws Exception
     */
    public int selectEntrprsMberListTotCnt(CmsSearchVO userSearchVO) throws Exception;
