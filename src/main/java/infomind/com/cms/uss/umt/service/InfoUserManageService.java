 ...
 * </pre>
 */
public interface InfoUserManageService {
	 ...
	 * @throws Exception
	 */
	public InfoUserManageVO selectUser(String emplyrId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<?> selectUserList(CmsSearchVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int selectUserListTotCnt(CmsSearchVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String insertUserHistory(InfoUserManageVO userManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updatePassword(InfoUserManageVO userManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public InfoUserManageVO selectPassword(InfoUserManageVO passVO) throws Exception;
