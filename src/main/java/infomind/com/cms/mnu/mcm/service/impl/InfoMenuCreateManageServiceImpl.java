package infomind.com.cms.mnu.mcm.service.impl;

import egovframework.com.cmm.EgovWebUtil;
import egovframework.com.cmm.util.EgovResourceCloseHelper;
import egovframework.rte.fdl.cmmn.EgovAbstractServiceImpl;
import infomind.com.cms.mnu.mcm.dao.InfoMenuCreateManageDAO;
 ...
 * </pre>
 */
@Service("infoMeunCreateManageService")
public class InfoMenuCreateManageServiceImpl extends EgovAbstractServiceImpl implements InfoMenuCreateManageService {

	private static final Logger LOGGER = LoggerFactory.getLogger(InfoMenuCreateManageServiceImpl.class);

	@Resource(name = "infoMenuCreateManageDAO")
	private InfoMenuCreateManageDAO menuCreateManageDAO;
	 ...
	 * @exception Exception
	 */
	public int selectMenuCreatManagTotCnt(CmsSearchVO vo) throws Exception {
	...
	/**
	 * 사이트맵 등록
	 * @param menuSiteMapvo InfoMenuSiteMapVO
	 * @param vHtmlValue   String
	 * @return boolean
	 * @exception Exception
	 */
	public boolean creatSiteMap(InfoMenuSiteMapVO menuSiteMapvo, String vHtmlValue) throws Exception {
		boolean chkCreat = false;
		String vSiteMapName = null;
		int SiteMapCnt = 0;
		//String newMapCreatId = null;
		InfoMenuCreatVO menuCreatVO = new InfoMenuCreatVO();
