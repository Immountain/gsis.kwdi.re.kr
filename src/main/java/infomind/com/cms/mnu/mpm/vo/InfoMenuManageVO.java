package infomind.com.cms.mnu.mpm.vo;
...
public class InfoMenuManageVO {
	...
	private List<InfoMenuManageVO> childMenu = new ArrayList<>();


	public List<InfoMenuManageVO> getChildMenu() {
		return childMenu;
	}

	public void setChildMenu(List<InfoMenuManageVO> childMenu) {
	...
	//자식 저장
	public void addChildMenu(InfoMenuManageVO menu) {
		childMenu.add(menu);
		childMenu.sort(Comparator.comparingInt(InfoMenuManageVO::getMenuOrdr));
	}
