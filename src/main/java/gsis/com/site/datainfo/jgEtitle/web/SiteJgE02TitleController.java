...
@Controller
public class SiteJgE02TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/site/gsis/e02/List.do")
    public ModelAndView List(@RequestBody JewE02TiileDataVO searchVO) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("jsonView");
        modelAndView.addObject("list",jgE02TitleService.getSelectList(searchVO));
