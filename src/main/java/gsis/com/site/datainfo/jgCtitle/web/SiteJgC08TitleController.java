...
@Controller
public class SiteJgC08TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/site/gsis/c08/List.do")
    public ModelAndView List(@RequestBody JewC08TiileDataVO searchVO) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("jsonView");
        modelAndView.addObject("list",jgC08TitleService.getSelectList(searchVO));
