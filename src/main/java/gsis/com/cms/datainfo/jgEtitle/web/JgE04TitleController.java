...
@Controller
public class JgE04TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/e04/List.do")
    public ModelAndView List(@RequestBody JewE04TiileDataVO searchVO) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("jsonView");
        modelAndView.addObject("list",jgE04TitleService.selectList(searchVO));
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/e04/upload.do", method = RequestMethod.POST)
    @ResponseBody
    public Object excelUpload(@RequestParam(value = "uploadFile") MultipartFile file) throws Exception {
        ...
        List<JewE04TiileDataVO> list = reader.read(JewE04TiileDataVO.class, file.getInputStream(), 0);
        return list;
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/cms/gsis/e04/updateObject.do")
    @ResponseBody
    public ModelAndView updateObject(@RequestBody JewE04TiileDataVO vo) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/e04/download.do", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity excelDownload(JewE04TiileDataVO searchVO, HttpServletResponse response) throws Exception {




        jgE04TitleService.excelDownload(searchVO,response);
