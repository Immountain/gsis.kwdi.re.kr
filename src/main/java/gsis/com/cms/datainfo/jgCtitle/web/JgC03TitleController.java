...
@Controller
public class JgC03TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/c03/List.do")
    public ModelAndView List(@RequestBody JewC03TiileDataVO searchVO) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("jsonView");
        modelAndView.addObject("list",jgC03TitleService.selectList(searchVO));
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/c03/upload.do", method = RequestMethod.POST)
    @ResponseBody
    public Object excelUpload(@RequestParam(value = "uploadFile") MultipartFile file) throws Exception {
        ...
        List<JewC03TiileDataVO> list = reader.read(JewC03TiileDataVO.class, file.getInputStream(), 0);
        return list;
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/cms/gsis/c03/updateObject.do")
    @ResponseBody
    public ModelAndView updateObject(@RequestBody JewC03TiileDataVO vo) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/c03/download.do", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity excelDownload(JewC03TiileDataVO searchVO, HttpServletResponse response) throws Exception {




        jgC03TitleService.excelDownload(searchVO,response);
