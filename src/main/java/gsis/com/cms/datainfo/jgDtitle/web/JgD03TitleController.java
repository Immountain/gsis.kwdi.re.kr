...
@Controller
public class JgD03TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d03/List.do")
    public ModelAndView List(@RequestBody JewD03TiileDataVO searchVO) throws Exception{
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("jsonView");
        modelAndView.addObject("list",jgD03TitleService.selectList(searchVO));
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d03/upload.do", method = RequestMethod.POST)
    @ResponseBody
    public Object excelUpload(@RequestParam(value = "uploadFile") MultipartFile file) throws Exception {
        ...
        List<JewD03TiileDataVO> list = reader.read(JewD03TiileDataVO.class, file.getInputStream(), 0);
        return list;
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/cms/gsis/d03/updateObject.do")
    @ResponseBody
    public ModelAndView updateObject(@RequestBody JewD03TiileDataVO vo) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d03/download.do", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity excelDownload(JewD03TiileDataVO searchVO, HttpServletResponse response) throws Exception {




        jgD03TitleService.excelDownload(searchVO,response);
