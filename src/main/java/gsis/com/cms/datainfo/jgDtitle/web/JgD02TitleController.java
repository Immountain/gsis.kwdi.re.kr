...
@Controller
public class JgD02TitleController extends BaseAjaxController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d02/List.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d02/upload.do", method = RequestMethod.POST)
    @ResponseBody
    public Object excelUpload(@RequestParam(value = "uploadFile") MultipartFile file) throws Exception {
        ...
        List<JewD02TiileDataVO> list = reader.read(JewD02TiileDataVO.class, file.getInputStream(), 0);
        return list;
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/cms/gsis/d02/updateObject.do")
    @ResponseBody
    public ModelAndView updateObject(@RequestBody JewD02TiileDataVO vo) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cms/gsis/d02/download.do", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity excelDownload(JewD02TiileDataVO searchVO, HttpServletResponse response) throws Exception {




        jgD02TitleService.excelDownload(searchVO,response);
