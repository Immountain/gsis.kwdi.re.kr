package gsis.com.cms.stats.web;
...
import gsis.com.cms.stats.service.JewStatsCategoryService;
...
public class JewStatsCategoryController extends BaseAjaxController {
    ...
    /** 대 카테고리 목록*/
    @IncludedInfo(name="통계DB카테고리", listUrl = "/cms/gsis/stats/jewStatsCategoryList.do", order = 1111, gid = 60)
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryList.do")
    ...
    /** 대 카테고리 grid ajax */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryObject.do")
    ...
    /** 대 카테고리 등록화면 */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryRegistView.do")
    ...
    /** 카테고리 insert */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryRegist.do")
    @ResponseBody
    ...
    /** 대 카테고리 수정화면 */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryUpdtView.do")
    ...
    /** 카테고리 UPDATE */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryUpdt.do")
    @ResponseBody
    ...
    /** 카테고리 삭제 */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategoryDelete.do")
    @ResponseBody
    ...
    /** 하위 카테고리 List */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategorySubList.do")
    ...
    /** 하위 카테고리 등록화면 */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategorySubRegistView.do")
    ...
    /** 카테고리 insert */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategorySubRegist.do")
    @ResponseBody
    ...
    /** 하위 카테고리 수정화면 */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategorySubUpdtView.do")
    ...
    /** 하위 카테고리 UPDATE */
    @RequestMapping(value="/cms/gsis/stats/jewStatsCategorySubUpdt.do")
    @ResponseBody
