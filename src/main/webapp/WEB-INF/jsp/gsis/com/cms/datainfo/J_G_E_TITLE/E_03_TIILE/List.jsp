...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "계", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData2", label: "기획", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData3", label: "예산", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData4", label: "인사", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData5", label: "감사", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData6", label: "실국주무과", align: "center", width: 130 ,formatter: "money"},
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e03/List.do' />', {
            method: "POST",
