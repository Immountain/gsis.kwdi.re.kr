...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("여성의 경력단절 사유.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "결혼", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "임신/출산", align: "center", width: 120,formatter: "money"},
                {key: "cdmData3", label: "육아", align: "center", width: 120,formatter: "money"},
                {key: "cdmData4", label: "자녀교육", align: "center", width: 120,formatter: "money"},
                {key: "cdmData5", label: "가족돌봄", align: "center", width: 120,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c04/List.do' />', {
            method: "POST",
