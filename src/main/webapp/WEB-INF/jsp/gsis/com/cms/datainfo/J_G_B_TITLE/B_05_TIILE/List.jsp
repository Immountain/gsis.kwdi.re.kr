...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("2-9(여성 석‧박사과정 졸업자 현황).xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "석사학위취득자", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "박사학위취득자", align: "center", width: 120,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b05/List.do' />', {
            method: "POST",
