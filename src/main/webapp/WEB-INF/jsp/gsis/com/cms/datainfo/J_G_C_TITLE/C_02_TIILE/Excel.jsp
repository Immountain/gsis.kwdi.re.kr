...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "조건", align: "center", width: 90 },
                {key: "cdmData2", label: "15~19세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "20~24세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "25~29세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "30~34세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "35~39세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "40~44세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData8", label: "45~49세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData9", label: "50~54세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData10", label: "55~59세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData11", label: "60~64세", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData12", label: "65세 이상", align: "center", width: 90,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/c02/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c02/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/c02/download.do"/>"); //요청 보낼 주소
    ...
    function btn_add() {
        ...
        for (var i = 0; i <firstGrid.getList().length; i++) {
            ...
            var checkcdmData1 =firstGrid.getList()[i].cdmData1;

            if(strYear ==checkDataYear &&dataGb==checkDataGb&&cdmData1==checkcdmData1){
                check =true;
...
<div class="sub subView">
    ...
    <select id="cdmData1" name="cdmData1">
        <option value="경제활동인구">경제활동인구</option>
        <option value="고용률">고용률</option>
    </select>
