...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "전체", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "5급이상 공무원", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "6급이상 공무원", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "6급 공무원", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/e04/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e04/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/e04/download.do"/>"); //요청 보낼 주소
