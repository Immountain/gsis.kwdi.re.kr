...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("대학교 진학률.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "졸업자수", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "진학자수", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData3", label: "진학률", align: "center", width: 120 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b04/List.do' />', {
            method: "POST",
