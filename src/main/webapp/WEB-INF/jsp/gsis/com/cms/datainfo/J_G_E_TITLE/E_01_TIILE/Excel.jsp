...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "선거명", align: "center", width: 130 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "선거인", align: "center", width: 130 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "투표율", align: "center", width: 130 ,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/e01/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e01/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/e01/download.do"/>"); //요청 보낼 주소
