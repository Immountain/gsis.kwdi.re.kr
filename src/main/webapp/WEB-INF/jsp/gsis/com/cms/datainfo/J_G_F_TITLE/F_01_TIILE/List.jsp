...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("범죄위험에 대한 안전 인식.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "안전", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData2", label: "보통", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData3", label: "불안", align: "center", width: 200 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/f01/List.do' />', {
            method: "POST",
