...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "야간에 혼자 걷기 두려운 곳이 있음", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData2", label: "가로등이 없어서", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData3", label: "인적이 드물어서", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData4", label: "우범지역이므로", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData5", label: "CCTV가 없어서", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData6", label: "기 타", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData7", label: "두려운 곳이 없음", align: "center", width: 200 ,formatter: "money"}
        ...
        firstGrid2.setConfig({
            target: $('[data-ax5grid="first-grid2"]'),
            columns: [
                {key: "dataYear", label: "년도", align: "center", width: 60},
                {key: "dataGb", label: "구분", align: "center", width: 60},
                {key: "cdmData1", label: "야간에 혼자 걷기 불안함", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData2", label: "생활권 내에 보행안전 시설 부족", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData3", label: "생활권 내에 치안 시설 부족", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData4", label: "생활권 내에 인적 드묾", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData5", label: "생활권 내에 우범 지역 존재", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData6", label: "신문, 뉴스 등에서 사건, 사고 자주 접해서", align: "center", width: 200 ,formatter: "money"},
                {key: "cdmData7", label: "기타", align: "center", width: 200 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/f02/List.do' />', {
            method: "POST",
        ...
        $ifx.ajax('<c:url value='/cms/gsis/f02/List2.do' />', {
            method: "POST",
            data: JSON.stringify(p),
            success: function (res) {
                firstGrid2.setData(res.list);
            }
        })
...
<div class="sub subView">
    ...
    <div class="rows white-box">
        ...
        <div data-ax5grid="first-grid2" data-ax5grid-config="{}" style="height: 300px;"></div>
    </div>
