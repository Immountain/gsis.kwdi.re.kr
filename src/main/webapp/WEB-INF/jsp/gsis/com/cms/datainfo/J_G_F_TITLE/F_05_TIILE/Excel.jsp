...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "대기", align: "center", width: 150 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "수질", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "토양", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "소음·진동", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "녹지환경", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/f05/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/f05/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/f05/download.do"/>"); //요청 보낼 주소
