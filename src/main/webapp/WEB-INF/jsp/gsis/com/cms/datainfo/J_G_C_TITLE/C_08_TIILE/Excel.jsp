...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "전체 산업체", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "여성 대표자 산업체", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "여성대표자 비율", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "전체 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "여성 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "여성 종사자 비율", align: "center", width: 120,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/c08/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c08/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/c08/download.do"/>"); //요청 보낼 주소
