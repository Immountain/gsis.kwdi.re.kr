...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("5급 이상 관리직 여성 공무원 비율.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "전체", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData2", label: "5급이상 공무원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData3", label: "6급이상 공무원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData4", label: "6급 공무원", align: "center", width: 130 ,formatter: "money"},
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e04/List.do' />', {
            method: "POST",
