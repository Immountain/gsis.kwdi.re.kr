...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("가구주가구.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "가구수", align: "center", width: 80 ,formatter: "money"},
                {key: "cdmData2", label: "여성가구주 가구비율", align: "center", width: 130,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a05/List.do' />', {
            method: "POST",
