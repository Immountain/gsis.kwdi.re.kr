...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("전반적 가족관계 만족도.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "만족", align: "center", width: 80 ,formatter: "money"},
                {key: "cdmData2", label: "보통", align: "center", width: 80 ,formatter: "money"},
                {key: "cdmData3", label: "불만족", align: "center", width: 80 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a08/List.do' />', {
            method: "POST",
