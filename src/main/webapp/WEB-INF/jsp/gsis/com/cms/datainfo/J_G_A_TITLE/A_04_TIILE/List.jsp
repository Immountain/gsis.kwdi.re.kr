...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "출생건수", align: "center", width: 80 ,formatter: "money"},
                {key: "cdmData2", label: "조출생률", align: "center", width: 80,formatter: "money"},
                {key: "cdmData3", label: "사망건수", align: "center", width: 80,formatter: "money"},
                {key: "cdmData4", label: "조사망률", align: "center", width: 80,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a04/List.do' />', {
            method: "POST",
