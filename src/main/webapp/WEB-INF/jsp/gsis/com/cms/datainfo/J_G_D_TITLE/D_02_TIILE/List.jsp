...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("주관적 건강인지율.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData2", label: "매우 좋음", align: "center", width: 60 ,formatter: "money"},
                {key: "cdmData3", label: "좋은 편임", align: "center", width: 60,formatter: "money"},
                {key: "cdmData4", label: "보 통", align: "center", width: 60,formatter: "money"},
                {key: "cdmData5", label: "나쁜 편임", align: "center", width: 60,formatter: "money"},
                {key: "cdmData6", label: "매우 나쁨", align: "center", width: 60,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/d02/List.do' />', {
            method: "POST",
