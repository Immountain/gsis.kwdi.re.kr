...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("초･중･고등학교 학생 수 변화.xls");
        });
        ...
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: undefined, label: "초등학교",align: "center" ,columns:[
                    {key: "cdmData1", label: "학생수", align: "center", width: 120 ,formatter: "money"},
                    {key: "cdmData2", label: "여성", align: "center", width: 120 ,formatter: "money"},
                    {key: "cdmData3", label: "여성비율", align: "center", width: 120 ,formatter: "money"}
                ]},
                {key: undefined, label: "중학교",align: "center" ,columns:[
                    {key: "cdmData4", label: "학생수", align: "center", width: 120 ,formatter: "money"},
                    {key: "cdmData5", label: "여성", align: "center", width: 120,formatter: "money"},
                    {key: "cdmData6", label: "여성비율", align: "center", width: 120,formatter: "money"}
                ]},
                {key: undefined, label: "고등학교",align: 'center', columns: [
                    {key: "cdmData7", label: "학생수", align: "center", width: 120,formatter: "money"},
                    {key: "cdmData8", label: "여성", align: "center", width: 120,formatter: "money"},
                    {key: "cdmData9", label: "여성비율", align: "center", width: 120,formatter: "money"}
                ]}
            ],
            body:{
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b03/List.do' />', {
            method: "POST",
