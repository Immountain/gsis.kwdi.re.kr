...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("제7회 전국동시지방선거 입후보자 및 당선인 현황.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "선거명", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData2", label: "후보자 수", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData3", label: "후보자 시도지사", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData4", label: "후보자 교육감", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData5", label: "후보자 시도의회의원", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData6", label: "후보자 시도의회의원(지역구)", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData7", label: "후보자 시도의회의원(교육위원)", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData8", label: "후보자 비례대표", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData9", label: "당선인 수", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData10", label: "당선인 시도지사", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData11", label: "당선인 교육감", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData12", label: "당선인 시도의회의원", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData13", label: "당선인 시도의회의원(지역구)", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData14", label: "당선인 시도의회의원(교육위원)", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData15", label: "당선인 비례대표", align: "center", width: 100 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e02/List.do' />', {
            method: "POST",
