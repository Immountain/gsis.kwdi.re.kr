    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "선거명", align: "center", width: 160},
                {key: "cdmData2", label: "후보자 수", align: "center", width: 70 ,formatter: "money"},
                ...
                {key: "cdmData5", label: "후보자 시도의회의원", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData6", label: "후보자 시도의회의원(지역구)", align: "center", width: 170 ,formatter: "money"},
                {key: "cdmData7", label: "후보자 시도의회의원(교육위원)", align: "center", width: 170 ,formatter: "money"},
                {key: "cdmData8", label: "후보자 비례대표", align: "center", width: 100 ,formatter: "money"},
                {key: "cdmData9", label: "당선인 수", align: "center", width: 70 ,formatter: "money"},
                ...
                {key: "cdmData12", label: "당선인 시도의회의원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData13", label: "당선인 시도의회의원(지역구)", align: "center", width: 180 ,formatter: "money"},
                {key: "cdmData14", label: "당선인 시도의회의원(교육위원)", align: "center", width: 180 ,formatter: "money"},
