...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "출산전후 휴가급여 인원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData2", label: "출산전후 휴가급여 지급액", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData3", label: "육아휴직급여 인원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData4", label: "육아휴직급여 지급액", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData5", label: "육아기근단축급여 인원", align: "center", width: 130 ,formatter: "money"},
                {key: "cdmData6", label: "육아기근단축급여 지급액", align: "center", width: 130 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/d05/List.do' />', {
            method: "POST",
