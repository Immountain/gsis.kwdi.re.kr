...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("취업자의 직업.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "계", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "관리자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData3", label: "전문가 및 관련 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData4", label: "사무 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData5", label: "서비스 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData6", label: "판매 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData7", label: "농림어업숙련 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData8", label: "기능원 및 관련 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData9", label: "장치, 기계조작 및 조립 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData10", label: "단순 노무 종사자", align: "center", width: 120,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c06/List.do' />', {
            method: "POST",
