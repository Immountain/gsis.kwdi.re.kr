...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "선거명", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "후보자 수", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "후보자 시도지사", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "후보자 교육감", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "후보자 시도의회의원", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "후보자 시도의회의원(지역구)", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "후보자 시도의회의원(교육위원)", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData8", label: "후보자 비례대표", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData9", label: "당선인 수", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData10", label: "당선인 시도지사", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData11", label: "당선인 교육감", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData12", label: "당선인 시도의회의원", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData13", label: "당선인 시도의회의원(지역구)", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData14", label: "당선인 시도의회의원(교육위원)", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData15", label: "당선인 비례대표", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/e02/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e02/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/e02/download.do"/>"); //요청 보낼 주소
