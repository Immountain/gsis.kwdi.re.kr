...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "계", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "관리자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "전문가 및 관련 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "사무 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "서비스 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "판매 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "농림어업숙련 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData8", label: "기능원 및 관련 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData9", label: "장치, 기계조작 및 조립 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData10", label: "단순 노무 종사자", align: "center", width: 120,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/c06/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c06/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/c06/download.do"/>"); //요청 보낼 주소
