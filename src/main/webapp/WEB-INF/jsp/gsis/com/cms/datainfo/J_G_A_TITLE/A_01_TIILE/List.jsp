...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData4", label: "여성 비율", align: "center", width: 60,formatter: "money"},
                {key: "cdmData5", label: "외국인 전 체", align: "center", width: 120,formatter: "money"},
                {key: "cdmData6", label: "외국인 여 성", align: "center", width: 120,formatter: "money"},
                {key: "cdmData7", label: "외국인 남 성", align: "center", width: 120,formatter: "money"},
                {key: "cdmData8", label: "외국인 여성 비율", align: "center", width: 120,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a01/List.do' />', {
            method: "POST",
