...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "계", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "기획", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "예산", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "인사", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "감사", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "실국주무과", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/e03/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/e03/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/e03/download.do"/>"); //요청 보낼 주소
