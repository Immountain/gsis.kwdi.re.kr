...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("연령별 취업자.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData2", label: "15~19세", align: "center", width: 120,formatter: "money"},
                {key: "cdmData3", label: "20~29세", align: "center", width: 120,formatter: "money"},
                {key: "cdmData4", label: "30~39세", align: "center", width: 120,formatter: "money"},
                {key: "cdmData5", label: "40~49세", align: "center", width: 120,formatter: "money"},
                {key: "cdmData6", label: "50~59세", align: "center", width: 120,formatter: "money"},
                {key: "cdmData7", label: "60세 이상", align: "center", width: 120,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c05/List.do' />', {
            method: "POST",
