...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("3-7(임금근로자의 월평균 임금).xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "임금", align: "center", width: 90 ,formatter: "money"},
                {key: "cdmData2", label: "성별격차", align: "center", width: 90,formatter: "money"},
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c07/List.do' />', {
            method: "POST",
