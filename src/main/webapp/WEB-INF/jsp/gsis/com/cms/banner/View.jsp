...
<c:set var="pageTitle">메인배너 수정</c:set>
<script type="text/javascript">
    ...
    $(document.body).ready(function () {
        ...
        $('#btn_save').click(function() {
            ...
            var API_SERVER = "<c:url value='/cms/gsis/banner/updateJewBanner.do' />";
        ...
        <div class="rows white-box">
            <table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
                ...
                <tr>
                    ...
                    <td class="left">
                        <input type="date" id="strDt" name="strDt" value="${view.strDt}">
                        <div><form:errors path="strDt" cssClass="error" /></div>
                    </td>
                    <th>종료일<span class="pilsu">*</span></th>
                    <td class="left">
                        <input type="date" id="endDt" name="endDt" value="${view.endDt}">
                ...
                <form:hidden path="bannerSno"></form:hidden>
            </table>
        </div>
    </form:form>
    <!-- 하단 버튼 -->
