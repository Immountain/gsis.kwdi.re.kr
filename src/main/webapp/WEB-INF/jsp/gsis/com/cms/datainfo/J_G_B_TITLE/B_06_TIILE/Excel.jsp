...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "학교", align: "center", width: 90},
                {key: "cdmData2", label: "교장", align: "center", width: 90 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "교감", align: "center", width: 90 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "수석교사", align: "center", width: 90 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "보직교사", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "평교사", align: "center", width: 90,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "계", align: "center", width: 90,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/b06/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b06/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/b06/download.do"/>"); //요청 보낼 주소
    ...
    function btn_add() {
        ...
        for (var i = 0; i <firstGrid.getList().length; i++) {
            ...
            var checkCdmData1 =firstGrid.getList()[i].dataGb;
