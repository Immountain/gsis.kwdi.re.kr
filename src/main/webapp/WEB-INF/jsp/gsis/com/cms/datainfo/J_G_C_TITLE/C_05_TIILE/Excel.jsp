...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData2", label: "15~19세", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "20~29세", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "30~39세", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "40~49세", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "50~59세", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "60세 이상", align: "center", width: 120,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/c05/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c05/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/c05/download.do"/>"); //요청 보낼 주소
...
<div class="sub subView">
    ...
    <select id="dataGb" name="dataGb">
        ...
        <option value="여성-남성">여성-남성</option>
    </select>
