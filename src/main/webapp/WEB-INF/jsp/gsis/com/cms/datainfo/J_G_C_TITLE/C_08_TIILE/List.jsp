...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("3-8(사업체의 여성 대표자 및 여성 종사자 비율).xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "전체 산업체", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "여성 대표자 산업체", align: "center", width: 120,formatter: "money"},
                {key: "cdmData3", label: "여성대표자 비율", align: "center", width: 120,formatter: "money"},
                {key: "cdmData4", label: "전체 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData5", label: "여성 종사자", align: "center", width: 120,formatter: "money"},
                {key: "cdmData6", label: "여성 종사자 비율", align: "center", width: 120,formatter: "money"},
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c08/List.do' />', {
            method: "POST",
