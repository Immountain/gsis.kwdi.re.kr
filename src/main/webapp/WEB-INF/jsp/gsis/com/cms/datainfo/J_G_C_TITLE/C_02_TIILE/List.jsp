...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("연령별 경제활동인구 및 고용률.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {
                    key: undefined, label: "경제활동인구", align: "center" ,columns: [
                        {key: "cdmData2T", label: "15~19세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData3T", label: "20~24세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData4T", label: "25~29세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData5T", label: "30~34세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData6T", label: "35~39세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData7T", label: "40~44세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData8T", label: "45~49세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData9T", label: "50~54세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData10T", label: "55~59세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData11T", label: "60~64세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData12T", label: "65세 이상", align: "center", width: 60,formatter: "money"}

                    ]
                },

                {
                    key: undefined, label: "고용률", align: "center" ,columns: [
                        {key: "cdmData2", label: "15~19세", align: "center", width: 60,formatter: "money"},
                        ...
                        {key: "cdmData11", label: "60~64세", align: "center", width: 60,formatter: "money"},
                        {key: "cdmData12", label: "65세 이상", align: "center", width: 60,formatter: "money"}
                    ]
                },
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/c02/List.do' />', {
            method: "POST",
