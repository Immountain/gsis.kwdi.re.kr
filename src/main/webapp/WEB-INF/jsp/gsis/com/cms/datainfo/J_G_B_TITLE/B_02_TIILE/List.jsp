...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("제주형 돌봄 공동체 현황.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "수눌음 육아나눔터 신규", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData2", label: "수눌음 육아나눔터 누계", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData3", label: "사회적 돌봄공동체 참여팀 신규", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData4", label: "사회적 돌봄공동체 참여팀 누계", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData5", label: "사회적 참여가족 신규", align: "center", width: 120 ,formatter: "money"},
                {key: "cdmData6", label: "사회적 참여가족 누계", align: "center", width: 120 ,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b02/List.do' />', {
            method: "POST",
