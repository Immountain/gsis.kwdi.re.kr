...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("4-1(기대여명).xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "0세", align: "center", width: 60 ,formatter: "money"},
                {key: "cdmData2", label: "1세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData3", label: "5세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData4", label: "10세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData5", label: "15세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData6", label: "20세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData7", label: "25세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData8", label: "30세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData9", label: "35세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData10", label: "40세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData11", label: "45세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData12", label: "50세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData13", label: "55세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData14", label: "60세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData15", label: "65세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData16", label: "70세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData17", label: "75세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData18", label: "80세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData19", label: "85세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData20", label: "90세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData21", label: "95세", align: "center", width: 60,formatter: "money"},
                {key: "cdmData22", label: "100세 이상", align: "center", width: 60,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/d01/List.do' />', {
            method: "POST",
