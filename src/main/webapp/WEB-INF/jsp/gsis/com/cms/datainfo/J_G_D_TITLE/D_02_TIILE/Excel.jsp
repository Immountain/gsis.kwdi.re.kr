...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "연령", align: "center", width: 100},
                {key: "cdmData2", label: "매우 좋음", align: "center", width: 60 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "좋은 편임", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "보 통", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "나쁜 편임", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "매우 나쁨", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/d02/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/d02/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/d02/download.do"/>"); //요청 보낼 주소
    ...
    function btn_add() {
        ...
        for (var i = 0; i <firstGrid.getList().length; i++) {
            ...
            if(strYear ==checkDataYear &&dataGb==checkDataGb&&checkCdmData1==cdmData1){
                check =true;
...
<div class="sub subView">
    ...
    <select id="cdmData1" name="dataGb">
        <option value="전체">전체</option>
