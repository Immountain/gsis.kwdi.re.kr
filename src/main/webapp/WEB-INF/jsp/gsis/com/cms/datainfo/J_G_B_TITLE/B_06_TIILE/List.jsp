...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("초･중･고등학교의 직위별 여성교원 비율.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData2", label: "교장", align: "center", width: 90 ,formatter: "money"},
                {key: "cdmData3", label: "교감", align: "center", width: 90 ,formatter: "money"},
                {key: "cdmData4", label: "수석교사", align: "center", width: 90 ,formatter: "money"},
                {key: "cdmData5", label: "보직교사", align: "center", width: 90,formatter: "money"},
                {key: "cdmData6", label: "평교사", align: "center", width: 90,formatter: "money"},
                {key: "cdmData7", label: "계", align: "center", width: 90,formatter: "money"}


            ],
            body:{
                mergeCells: ["dataYear","cdmData1", "dataGb"]
            }
        });
    }
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b06/List.do' />', {
            method: "POST",
