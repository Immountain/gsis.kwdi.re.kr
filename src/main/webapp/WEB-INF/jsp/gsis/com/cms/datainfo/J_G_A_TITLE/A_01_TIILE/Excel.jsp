...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "전 체", align: "center", width: 60 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "여 성", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "남 성", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "여성 비율", align: "center", width: 60,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "외국인 전 체", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "외국인 여 성", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData7", label: "외국인 남 성", align: "center", width: 120,formatter: "money",editor: {type: "text"}},
                {key: "cdmData8", label: "외국인 여성 비율", align: "center", width: 120,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/a01/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a01/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/a01/download.do"/>"); //요청 보낼 주소
