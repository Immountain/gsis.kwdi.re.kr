...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                {key: "dataYear", label: "전체", align: "center", width: 60},
                {key: "dataGb", label: "구분", align: "center", width: 60},
                {key: "cdmData1", label: "안전", align: "center", width: 150 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "보통", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "불안", align: "center", width: 100 ,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/f01/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
     ...
     if(!confirm('데이터을 생성 하시겠습니까?')) return false;
        ...
        $ifx.ajax('<c:url value='/cms/gsis/f01/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/f01/download.do"/>"); //요청 보낼 주소
