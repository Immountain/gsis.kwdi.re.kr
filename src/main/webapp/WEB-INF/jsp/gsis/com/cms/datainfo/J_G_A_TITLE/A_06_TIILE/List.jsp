...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("1인 가구의 성별 구성.xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "계", align: "center", width: 80 ,formatter: "money"},
                {key: "cdmData2", label: "비율", align: "center", width: 80,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a06/List.do' />', {
            method: "POST",
