    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "경제활동인구", align: "center", width: 90 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "경제활동참가율", align: "center", width: 90,formatter: "money",editor: {type: "text"}}
