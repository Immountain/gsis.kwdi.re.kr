...
<script type="text/javascript">
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "수눌음 육아나눔터 신규", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData2", label: "수눌음 육아나눔터 누계", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData3", label: "사회적 돌봄공동체 참여팀 신규", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData4", label: "사회적 돌봄공동체 참여팀 누계", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData5", label: "사회적 참여가족 신규", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}},
                {key: "cdmData6", label: "사회적 참여가족 누계", align: "center", width: 120 ,formatter: "money",editor: {type: "text"}}
    ...
    function gridExcelUplad() {
        ...
        $ifx.ajax('<c:url value="/cms/gsis/b02/upload.do"/>', {
            method: 'POST',
            processData: false,
            contentType: false,
            data: formData,
    ...
    function saveGrid() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/b02/updateObject.do' />', {
            method: "POST",
    ...
    function download() {
        ...
        form.setAttribute("action", "<c:url value="/cms/gsis/b02/download.do"/>"); //요청 보낼 주소
