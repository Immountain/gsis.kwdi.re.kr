...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_down_excel').click(function () {
            firstGrid.exportExcel("1-4(농가 및 어가 인구)_0806_Y).xls");
        });
    ...
    function genGrid() {
        firstGrid.setConfig({
            ...
            columns: [
                ...
                {key: "cdmData1", label: "농가인구", align: "center", width: 90 ,formatter: "money"},
                {key: "cdmData2", label: "어가인구", align: "center", width: 90,formatter: "money"}
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/gsis/a02/List.do' />', {
            method: "POST",
