...
<script type="text/javascript">
    ...
    function initChartEl() {
        ...
        chartView = Highcharts.chart('chartView', {
            ...
            xAxis: [{
                categories: ['관리자','전문가 및 관련 종사자','사무 종사자','서비스 종사자','판매 종사자','농림어업숙련 종사자','기능원 및 관련 종사자','장치, 기계조작 및 조립 종사자','단순 노무 종사자'],
                crosshair: true
            }],
            yAxis: [{ // Primary yAxis
                labels: {
    ...
    function Search() {
        ...
        $ifx.promise()
            .then(function (ok, fail, data) {
                $ifx.ajax('<c:url value='/site/gsis/c06/List.do' />', {
                    method: "POST",
            ...
            .then(function (ok, fail, data) {
                ...
                $.each(data, function(key, item) {
                    ...
                    if(item.dataGb=="여성"){
                        ...
                        cdmData1.push(Number(item.cdmData10))
                    ...
                    if(item.dataGb=="남성"){
                        ...
                        cdmData2.push(Number(item.cdmData10))
