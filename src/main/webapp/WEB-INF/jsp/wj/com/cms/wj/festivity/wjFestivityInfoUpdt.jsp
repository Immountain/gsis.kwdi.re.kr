...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		mapContainer = document.getElementById('map'), // 지도를 표시할 div
				mapOption = {
					center: new kakao.maps.LatLng(_latitude, _longitude), //지도의 중심좌표.
					level: 3 // 지도의 확대 레벨
				};
    ...
    ******************************************************** */
	...
	function fnUpdate(){
		...
		var	API_SERVER = "<c:url value='/cms/wj/festivity/UpdateWjFestivityInfo.do'/>";
	...
	<div class="rows white-box">
		...
		<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
			<tr>
				...
				<td class="left">
					<form:input path="festivityId" maxlength="10" readonly="true"/>
					...
					<c:forEach var="result" items="${resultVO.listLang}" varStatus="status">
						...
						<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />" style="display: none;" data-incms-id="${result.langCode}">
							...
							<tr>
								...
								<td class="left">
									<form:textarea path="listLang[${status.index}].festivityScale" size="40" maxlength="250" />
