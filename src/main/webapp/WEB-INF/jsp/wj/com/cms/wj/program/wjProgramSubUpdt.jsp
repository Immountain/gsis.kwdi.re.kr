...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//서브프로그램수정
		$('#btn_modify_updt').click(function(){
			var title = $('#title').val();
			...
			var	API_SERVER = "<c:url value='/cms/wj/program/UpdtWjProgramSub.do'/>";
...
<form:form commandName="resultVO">
	...
	<div class="rows white-box">
		...
		<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
			...
			<input type="hidden" id="programSubSno" name="programSubSno" value="<c:out value="${resultVO.programSubSno}"/>">
	...
	<!-- 하단 버튼 -->
		<div class="btn-set right">
			<button type="button" id="btn_modify_updt" name="btn_modify_updt" class="btn main" name="btn_save">수정</button>
		</div>
