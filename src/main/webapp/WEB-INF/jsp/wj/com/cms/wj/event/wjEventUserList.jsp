		...
		<div class="rows white-box">
			<table class="basic" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				...
				<c:forEach items="${list}" var="item" varStatus="status">
					<tr>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${(searchVO.pageIndex-1) * searchVO.pageSize + status.count}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.festivityId}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationId}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationGb}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationNm}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationContent}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationMemo}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationStrDt}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.applicationEntDt}"/></td>
						<td class="center" style = "cursor:pointer;" onclick="javascript:fnFestivityInfoUpdate('<c:out value="${item.eventUserSno}"/>');"><c:out value="${item.useYn}"/></td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
