...
<script type="text/javascript">
    ...
    ******************************************************** */
	...
	function fnInsert(){
		...
		var	API_SERVER = "<c:url value='/cms/wj/program/RegistWjProgramInfo.do'/>";
	...
	<div class="rows white-box">
		...
		<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
			...
			<tr>
				...
				<td class="left">
					<form:input path="programEtc" maxlength="100"/>
				</td>
...
<%--						</sctipt>--%>
						...
						<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />" style="display: none;" data-incms-id="${result.langCode}">
							<tr>
								...
								<td class="left">
									<form:input path="listLang[${status.index}].programNm" size="40" maxlength="250" />
								</td>
								<th width="10%"><label for="listLang[${status.index}].programPlace">프로그램장소<span class="pilsu">*</span></label></th>
								<td class="left">
									<form:input path="listLang[${status.index}].programPlace" size="40" maxlength="250" />
								</td>
							</tr>
							<tr>
								<th width="10%"><label for="listLang[${status.index}].programEtc">프로그램 기타 <span class="pilsu">*</span></label></th>
								<td class="left">
									<form:input path="listLang[${status.index}].programEtc" size="40" maxlength="250"/>
								</td>
