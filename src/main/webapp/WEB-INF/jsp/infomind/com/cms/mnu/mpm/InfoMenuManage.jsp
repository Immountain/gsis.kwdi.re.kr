...
function fDeleteMenuList() {
    ...
    document.menuManageForm.action = "<c:url value='/cms/mnu/mpm/infoMenuManageListDelete.do'/>";
...
//	document.menuManageForm.searchKeyword.value =
	...
	document.menuManageForm.action = "<c:url value='/cms/mnu/mpm/infoMenuManageSelect.do'/>";
   	document.menuManageForm.submit();
}
...
function insertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/cms/mnu/mpm/infoMenuRegistInsert.do'/>";
   	document.menuManageForm.submit();
}
 ...
 */
function bndeInsertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/cms/mnu/mpm/infoMenuBndeRegist.do'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtMenuManageDetail(menuNo) {
	document.menuManageForm.req_menuNo.value = menuNo;
   	document.menuManageForm.action = "<c:url value='/cms/mnu/mpm/infoMenuManageListDetailSelect.do'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 최초조회 함수
...
<div class="board">
	...
	<form name="menuManageForm" action ="<c:url value='/cms/mnu/mpm/infoMenuManageSelect.do'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<input class="s_input2 vat" name="searchKeyword" type="text" value="${searchVO.searchKeyword }" size="25" title="<spring:message code="title.searchCondition"/>" maxlength="200"/><!-- 검색조건 -->
				...
				<span class="btn_b"><a href="<c:url value='/cms/mnu/mpm/infoMenuRegistInsert.do'/>" onclick="bndeInsertMenuManage(); return false;" title="<spring:message code="button.bulkUpload" />"><spring:message code="button.bulkUpload" /></a></span><!-- 일괄등록 -->
				<span class="btn_b"><a href="<c:url value='/cms/mnu/mpm/infoMenuRegistInsert.do'/>" onclick="insertMenuManage(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			...
			<c:forEach var="result" items="${list_menumanage}" varStatus="status">
			  <tr>
			    ...
			    <td style="cursor:hand;">
			       <span class="link"><a href="<c:url value='/cms/mnu/mpm/infoMenuManageListDetailSelect.do?req_menuNo='/>${result.menuNo}" onclick="selectUpdtMenuManageDetail('<c:out value="${result.menuNo}"/>'); return false;"><c:out value="${result.menuNm}"/></a></span>
			    </td>
