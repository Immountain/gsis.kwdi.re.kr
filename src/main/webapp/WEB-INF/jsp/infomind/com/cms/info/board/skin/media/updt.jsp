...
<c:set var="pageTitle">언론보도 게시판</c:set>
        ...
        <div class="rows white-box">
            ...
            <table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
                ...
                <tr>
                    ...
                    <th style="width: 9%;">
                        <label for="memo">언론사<span class="pilsu">*</span></label>
                    </th>
                    <td class="left">
                ...
                <tr>
                    <th style="width: 9%;">
                        <label for="temp1">등록일<span class="pilsu">*</span></label>
                    </th>
                    <td class="left">
                ...
                <tr>
                    <th style="width: 9%;">
                        <label for="temp2">조회수<span class="pilsu">*</span></label>
                    </th>
                    <td class="left">
