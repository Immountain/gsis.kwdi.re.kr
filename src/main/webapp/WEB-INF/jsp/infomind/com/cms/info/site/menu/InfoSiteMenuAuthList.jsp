...
<script type="text/javascript">
	var SITE_MEMU_ID = '${searchVO.siteMemuId}';
	...
	function searchGrid() {
		...
		.then(function (ok, fail, data) {
			...
			$ifx.ajax('<c:url value='/cms/info/site/menu/menuAuthConfigListObject.do' />', {
				method: "GET",
				data: p,
				success: function (res) {
					res.list.forEach(function(v) {
						v['list'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'list'}) ? true : false
						v['read'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'read'}) ? true : false
						v['write'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'write'}) ? true : false
						v['comment'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'comment'}) ? true : false
						v['reply'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'reply'}) ? true : false
						v['notice'] = v.auths.find(function(d) {return d.memuAuthId && d.authAccess === 'notice'}) ? true : false
					})
	...
	function updateGrid() {
		...
		$ifx.ajax('<c:url value='/cms/info/site/menu/menuAuthConfigUpdateObject.do' />?siteMemuId=' + SITE_MEMU_ID, {
			method: "POST",
