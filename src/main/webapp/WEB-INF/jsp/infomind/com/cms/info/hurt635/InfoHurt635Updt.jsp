...
function fn_update_page(form){
	...
	if(confirm("<spring:message code="common.update.msg" />")){
		form.action="<c:url value='/cms/info/hurt635/updateHurt635.do' />";
		form.submit();
	}
}
...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/hurt635/insertHurt635.do" method="post" onSubmit="fn_update_page(document.forms[0]); return false;">
				...
				<tbody>
					...
					<tr><!-- IP 주소 -->
						...
						<td class="left" colspan="4">
							<form:input path="ip1" id="ip1" cssClass="txaIpUmt"  maxlength="3" style="width:60px;" onKeyup="this.value=this.value.replace(/[^0-9*]/g,'');" onfocus="this.value=''"/>
							. <form:input path="ip2" id="ip2" cssClass="txaIpUmt"  maxlength="3" style="width:60px;" onKeyup="this.value=this.value.replace(/[^0-9*]/g,'');" onfocus="this.value=''"/>
							. <form:input path="ip3" id="ip3" cssClass="txaIpUmt"  maxlength="3" style="width:60px;" onKeyup="this.value=this.value.replace(/[^0-9*]/g,'');" onfocus="this.value=''"/>
							. <form:input path="ip4" id="ip4" cssClass="txaIpUmt"  maxlength="3" style="width:60px;" onKeyup="this.value=this.value.replace(/[^0-9*]/g,'');" onfocus="this.value=''"/>
							숫자 또는 *만 입력 가능합니다.
