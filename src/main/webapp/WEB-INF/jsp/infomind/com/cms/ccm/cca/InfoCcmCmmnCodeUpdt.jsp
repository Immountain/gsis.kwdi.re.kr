...
function fn_egov_inqire_code() {
	cmmnCodeVO.action = "<c:url value='/cms/ccm/cca/SelectCcmCmmnCodeList.do'/>";
	cmmnCodeVO.submit();	
}
</script>
...
<div class="sub subView">
	<h2 class="stitle">
		<i class='bx bxs-dashboard' ></i>${pageTitle} <spring:message code="title.update" />
			...
			<!-- 상단타이틀 -->
			<form:form commandName="cmmnCodeVO" action="${pageContext.request.contextPath}/cms/ccm/cca/UpdateCcmCmmnCode.do" method="post" onSubmit="fn_egov_updt_code(document.forms[0]); return false;">
			...
			<div class="rows white-box">
				...
				<div class="btn-set right">
					...
					<a href="<c:url value='/cms/ccm/cca/SelectCcmCmmnCodeList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" class="button" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
				</div>
