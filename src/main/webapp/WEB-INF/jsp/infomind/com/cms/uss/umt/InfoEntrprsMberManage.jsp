...
<c:set var="pageTitle">기관담당자관리</c:set>
<head>
...
*/
		function fnSelectUser(id) {
			...
			if(readYnCnt>0){
				...
				document.listForm.action = "<c:url value='/cms/uss/umt/InfoEntrprsMberSelectUpdtView.do'/>";
				document.listForm.submit();
			}else{
		...
		function fnLinkPage(pageNo){
			...
			document.listForm.action = "<c:url value='/cms/uss/umt/InfoEntrprsMberManage.do'/>";
			document.listForm.submit();
		}
		function fnSearch(){
...
<div class="sub subView">
	...
	<form name="listForm" action="<c:url value='/cms/uss/umt/InfoEntrprsMberManage.do'/>" method="post"  onSubmit="fnSearch(); return false;">
			...
			<table  class="basic" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				...
				<c:forEach items="${resultList}" var="result" varStatus="status">
					<tr >
						...
						<td style = "cursor:pointer;" onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>');"class="left"><c:out value="${result.applcntNm}"/></td>
						...
						<td style = "cursor:pointer;" onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>');"class="center">
							<c:out value="${result.startMoblno}"/>-<c:out value="${result.middleMoblno}"/>-<c:out value="${result.endMoblno}"/>
						</td>
						...
						<td style = "cursor:pointer;" onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>');"class="center"><c:out value="${result.groupNm}"/></td>
						</td>
