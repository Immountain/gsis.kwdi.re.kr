...
function fn_info_select_linkPage(pageNo){
	...
	document.searchVO.action = "<c:url value='/cms/info/board/popBoardList.do'/>";
...
<div class="sub subView">
	...
	<form name="searchVO" action="<c:url value='/cms/info/board/popBoardList.do'/>" method="post" onSubmit="fn_info_search_page(); return false;">
		<!-- 검색영역 -->
		<!-- 검색조건선택 -->
		<div class="white-box">
			<div class="rows">
				...
				<tbody>
					...
					<c:forEach items="${list}" var="item" varStatus="status">
						<tr>
							...
							<td class="center">
								<a ax-event="<c:out value='${item.boardId}'/>">
