...
function fnSelectUser(id) {
	...
	if(readYnCnt>0) {
		...
		document.listForm.action = "<c:url value='/cms/uss/umt/InfoUserSelectUpdtView.do'/>";
		document.listForm.submit();
...
function fnAddUserView() {
    document.listForm.action = "<c:url value='/cms/uss/umt/InfoUserInsertView.do'/>";
    document.listForm.submit();
}
...
function fnLockIncorrect(uniqId) {
    if (confirm("<spring:message code="comUssUmt.common.lockAtConfirm" />")) {
        document.listForm.action = "<c:url value='/cms/uss/umt/InfoUserLockIncorrectList.do'/>";
        document.listForm.uniqId.value = uniqId;
        document.listForm.submit();
    }
}
...
<div class="sub subView">
	...
	<tr>
	    ...
	    <td class="center"><a href="<c:url value='/cms/uss/umt/InfoMberSelectUpdtView.do'/>?selectedId=<c:out value="${result.uniqId}"/>"  onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>'); return false;"><c:out value="${result.userId}"/></a></td>
