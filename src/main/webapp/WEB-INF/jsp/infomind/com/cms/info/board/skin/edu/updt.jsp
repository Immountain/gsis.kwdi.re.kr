...
<c:set var="pageTitle">교육정보 게시판</c:set>
    ...
    <form:form commandName="resultVO" id="resultVO" name="resultVO" action="${pageContext.request.contextPath}/cms/info/board/c/update.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
        ...
        <div class="rows white-box">
            ...
            <table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
                ...
                <tr>
                    <th style="width: 9%;">
                        <label for="title">교육 제목<span class="pilsu">*</span></label>
                    </th>
                    <td class="left">
                    ...
                    <th style="width: 9%;">
                        <label for="memo">교육 메모<span class="pilsu">*</span></label>
                    </th>
                    <td class="left">
                ...
                <tr>
                    <th>교육유형<span class="pilsu">*</span></th>
                    <td class="left">
                        <form:select path="category" title="교육유형">
                            <form:options items="${categoryList}" itemValue="boardCategoryId" itemLabel="boardCategoryNm" />
                        </form:select>
                        <div><form:errors path="category" cssClass="error" /></div>
                    </td>
                </tr>
                <tr>
                    <th>교육 공지여부<span class="pilsu">*</span></th>
                    <td class="left">
                ...
                <tr>
                    <th><label for="strDay">교육 게시일자 </label></th>
                    <td class="left">
                ...
                <tr>
                    <th><label for="strDay">교육 시작 시간 </label></th>
                    <td class="left">
                ...
                <tr>
                    <th><label for="strDay">교육 종료 시간 </label></th>
                    <td class="left">
                ...
                <tr>
                    <th><label for="boardContent">교육 내용 <span class="pilsu">*</span></label></th>
                    <td class="nopd">
                        <div>
                            <form>
