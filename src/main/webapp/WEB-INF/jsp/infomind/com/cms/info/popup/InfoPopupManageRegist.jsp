...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/popup/insertPopupManage.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
			...
			<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				<tbody>
					...
					<tr>
						...
						<td class="left">
							<form:input path="popupId"  size="70" maxlength="10" />
							<div><form:errors path="popupId" cssClass="error" /></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="left">
							<input type="date" id="ntceBgnde" name="ntceBgnde" value="${resultVO.strDay}">
					...
					<tr>
						...
						<td class="left">
							...
							<input type="date" id="ntceEndde" name="ntceEndde" value="${resultVO.endDay}">
		...
		<div class="btn-set right">
			...
			<span class="button"><a href="<c:url value='/cms/info/popup/popupManageList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
		</div>
