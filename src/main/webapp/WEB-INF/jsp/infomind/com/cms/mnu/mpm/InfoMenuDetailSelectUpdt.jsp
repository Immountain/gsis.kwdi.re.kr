...
function updateMenuManage(form) {
	...
	if(confirm("<spring:message code="common.save.msg"/>")){
		...
		if(!validateMenuManageVO(form)){
            ...
            form.action="<c:url value='/cms/mnu/mpm/infoMenuDetailSelectUpdt.do' />";
			form.submit();
		}
	}
}
...
function deleteMenuManage(form) {
	if(confirm("<spring:message code="common.delete.msg"/>")){
        form.action="<c:url value='/cms/mnu/mpm/infoMenuManageDelete.do' />";
		form.submit();
	}
}
/* ********************************************************
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/cms/mnu/mpm/infoMenuManageSelect.do' />";
}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#popupUpperMenuId').click(function (e) {
            ...
            //var page = $(this).attr("href");
            var pagetitle = $(this).attr("title");
            var page = "<c:url value='/cms/mnu/mpm/infoMenuListSelectMvmnNew.do'/>";
...
<form:form commandName="menuManageVO" name="menuManageVO"  action ="<c:url value='/cms/mnu/mpm/infoMenuDetailSelectUpdt.do' />" method="post">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/cms/mnu/mpm/infoMenuListSelectMvmn.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cms/mnu/mpm/infoMenuManageSelect.do'/>" onclick="selectList(); return false;"><spring:message code="button.list"/></a></span><!-- 목록 -->
	</div>
