...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/pageGroup/updatePageGroup.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
		...
		<div class="rows white-box">
			...
			<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				...
				<tr>
					...
					<td class="left">
						<form:input path="pageGroupId"  size="70" maxlength="70" readonly="true"/>
