...
<!-- 상단타이틀 -->
	<form:form commandName="cmmnDetailCodeVO" action="${pageContext.request.contextPath}/cms/ccm/cde/UpdateCcmCmmnDetailCode.do" method="post" onSubmit="fn_egov_updt_code(document.forms[0]); return false;">
	...
	<!-- 수정폼 -->
		...
		<tbody>
			...
			<tr>
				<th style="width: 9%;"><label for="codeId">${title} <span class="pilsu">*</span></label></th>
				<td class="left">
		...
		<div class="btn-set right">
			...
			<a href="<c:url value='/cms/ccm/cde/SelectCcmCmmnDetailCodeList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" class="button" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
		</div>
