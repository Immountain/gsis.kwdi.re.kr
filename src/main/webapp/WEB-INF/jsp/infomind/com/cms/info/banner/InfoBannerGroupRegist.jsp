...
<c:set var="pageTitle">배너 그룹 관리</c:set>
...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/banner/insertBannerGroup.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
			...
			<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				<tbody>
					...
					<tr>
						...
						<td class="left">
							<form:input path="bannerGroupId"  size="70" maxlength="100" />
		...
		<div class="btn-set right">
			...
			<span class="button"><a href="<c:url value='/cms/info/banner/bannerGroupList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
		</div>
