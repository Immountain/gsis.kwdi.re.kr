...
function fn_egov_list_code(){
	location.href = "<c:url value='/cms/ccm/cca/SelectCcmCmmnCodeList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
...
<div class="sub subView">
	...
	<form:form commandName="cmmnCodeVO" action="${pageContext.request.contextPath}/cms/ccm/cca/RegistCcmCmmnCode.do" method="post" onSubmit="fn_egov_regist_code(document.forms[0]); return false;">
		...
		<div class="rows white-box">
				...
				<tbody>
					...
					<tr>
						<th style="width: 9%;">
                            <label for="clCode">${title} <span class="pilsu">*</span></label>
                        </th>
						<td class="left">
					...
					<tr>
						...
						<td class="nopd">
							<form:textarea path="codeIdDc" title="${title} ${inputTxt}" cols="300" rows="10" />
			...
			<div class="btn-set right">
				...
				<span class="button"><a href="<c:url value='/cms/ccm/cca/SelectCcmCmmnCodeList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
			</div>
