...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/banner/insertBanner.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
			...
			<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				<tbody>
					...
					<tr>
						...
						<td class="left">
							<form:input path="bannerId"  size="70" maxlength="70" />
