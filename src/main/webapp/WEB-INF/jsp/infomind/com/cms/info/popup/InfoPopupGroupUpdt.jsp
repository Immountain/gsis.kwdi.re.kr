...
function fn_update_page(form){
	...
	if(confirm("<spring:message code="common.update.msg" />")){
		form.action="<c:url value='/cms/info/popup/updatePopupGroup.do' />";
		form.submit();
	}
}

function fncGoBack(){
	document.resultVO.action="<c:url value='/cms/info/popup/popupGroupList.do' />";
...
<div class="sub subView">
	...
	<form:form commandName="resultVO" name="resultVO" id="resultVO" action="${pageContext.request.contextPath}/cms/info/popup/updatePopupGroup.do" method="post" onSubmit="fn_update_page(document.forms[0]); return false;">
		<%--hidden text--%>
		...
		<input name="popupGroupId" id="popupGroupId" type="hidden" value="${resultVO.popupGroupId}">
