				...
				<tbody>
					...
					<c:forEach items="${list}" var="item" varStatus="status">
						<tr>
							...
							<td class="center"><c:out value="${item.noticeStartYyyy}-${item.noticeStartMm}-${item.noticeStartDd}"/></td>
							<td class="center"><c:out value="${item.noticeEndYyyy}-${item.noticeEndMm}-${item.noticeEndDd}"/></td>
