...
<div class="sub subView">
	...
	<form:form commandName="resultVO" action="${pageContext.request.contextPath}/cms/info/board/insertBoard.do" method="post" onSubmit="fn_regist_page(document.forms[0]); return false;">
				...
				<tbody>
					...
					<tr>
						...
						<td class="left" colspan="3">
							<form:input path="boardId"  size="70" maxlength="10" />
		...
		<div class="btn-set right">
			...
			<span class="button"><a href="<c:url value='/cms/info/board/boardList.do?menuTargetNo=${menuInfo.menuTargetNo}' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
		</div>
