...
<div class="sub subView">
	...
	<form:form commandName="infoPageImageGroupVO" action="${pageContext.request.contextPath}/cms/info/pageimage/updatePageImage.do" method="post">
		...
		<div class="rows white-box">
				...
				<tbody>
					...
					<tr>
						...
						<td class="left">
							<form:input path="imageId"  size="70" maxlength="10" readonly="true" />
			...
			<div class="btn-set right">
                <input class="button" type="submit" value='<spring:message code="button.update" />' onclick="fn_regist(document.forms[0]); return false;" /><!-- 저장 -->
