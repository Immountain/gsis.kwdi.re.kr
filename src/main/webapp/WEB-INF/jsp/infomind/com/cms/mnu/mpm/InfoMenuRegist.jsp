...
function mvmnMenuList() {
	window.open("<c:url value='/cms/mnu/mpm/infoMenuListSelectMvmn.do' />",'Pop_Mvmn','scrollbars=yes,width=600,height=600');
}
...
<form:form commandName="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/cms/mnu/mpm/infoMenuRegistInsert.do">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/cms/mnu/mpm/infoMenuListSelectMvmn.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>"><img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
