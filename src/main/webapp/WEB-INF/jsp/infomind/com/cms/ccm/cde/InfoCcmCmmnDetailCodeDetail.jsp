...
<script type="text/javascript">
	...
	function fn_egov_delete_code(codeId, code){
		if(confirm("<spring:message code="common.delete.msg" />")){
			...
			document.CcmDeCodeForm.action = "<c:url value='/cms/ccm/cde/RemoveCcmCmmnDetailCode.do'/>";
	...
	function fn_egov_modify_code(codeId, code) {
		...
		document.CcmDeCodeForm.action = "<c:url value='/cms/ccm/cde/UpdateCcmCmmnDetailCodeView.do'/>";
		document.CcmDeCodeForm.submit();
