...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formUpdt" action="<c:url value='/cms/uss/stp/InfolatCnUpdtView.do'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/cms/uss/stp/InfolatCnDelete.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/cms/uss/stp/InfolatListInqire.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
