		...
		<div class="rows white-box">
			...
			<table class="landscape" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
				<tbody>
					...
					<tr>
						<th><label for="bannerNm">다국어  <span class="pilsu">*</span></label></th>
						<td class="left">

							<div class="radio-field">
								<input type="radio" id="country01" name="country" checked>
								<label for="country01">한국어</label>
								<input type="radio" id="country02" name="country">
								<label for="country02">영어</label>
								<input type="radio" id="country03" name="country">
								<label for="country03">일본어</label>
								<input type="radio" id="country04" name="country">
								<label for="country04">중국어</label>
							</div>
