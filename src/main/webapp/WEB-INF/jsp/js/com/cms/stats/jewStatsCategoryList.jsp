...
<script type="text/javascript">
    ...
    function Search() {
        ...
        $ifx.ajax('<c:url value='/cms/js/stats/jewStatsCategoryObject.do' />', {
            method: "POST",
    ...
    function gotoRegist() {
        ...
        var p = {};
        var API_SERVER = "<c:url value='/cms/js/stats/jewStatsCategoryRegistView.do' />";
        ax5modal.open({
            theme: "primary",
            height: 400,
            width: 800,
    ...
    function gotoUpdt(row) {
        ...
        var API_SERVER = "<c:url value='/cms/js/stats/jewStatsCategoryUpdtView.do' />";
        ax5modal.open({
            theme: "primary",
            height: 350,
            width: 800,
    ...
    function gotoDelete(row){
        ...
        var API_SERVER = "<c:url value='/cms/js/stats/jewStatsCategoryDelete.do' />";
    ...
    function gotoCategory(row) {
        ...
        var API_SERVER = "<c:url value='/cms/js/stats/jewStatsCategorySubList.do' />";
        ax5modal.open({
            theme: "primary",
            height: 511,
            width: 1226,
